...
import cv2
from nets import MSSL_3dpw as MSSL
...
tf.app.flags.DEFINE_string('train_data_paths',
                           'data/3dpw_ske/train_3dpw0_25.npy',
                           'train data paths.')
tf.app.flags.DEFINE_string('valid_data_paths',
                           'data/3dpw_ske/test_3dpw0_25.npy',
...
tf.app.flags.DEFINE_integer('jointsdim', 3,
                            'Joint dimension.')
tf.app.flags.DEFINE_integer('jointsnum', 23,
                            'Joint number to predict.')
tf.app.flags.DEFINE_integer('totaljointsnum', 24,
